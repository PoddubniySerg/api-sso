...
// Объект, который RPC-метод Register() вернёт.
...
// Объект, который отправляется при вызове RPC-метода Login()
...
// Объект, который RPC-метод Login() вернёт.
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x69, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76, 0x31,
